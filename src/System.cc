...
namespace ORB_SLAM2
{
                                                                 ...
                                                                 map_file(map_file), load_map(load_map)
    {
        ...
        mpLocalMapper->SetSemiDenseMapping(mpSemiDenseMapping);
    ...
    while (!mpLocalMapper->isFinished() || !mpLoopCloser->isFinished() || mpLoopCloser->isRunningGBA() || !mpSemiDenseMapping->isFinished() || !mpModeler->isFinished())
    {
